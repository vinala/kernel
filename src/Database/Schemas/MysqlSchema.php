...
class MysqlSchema extends Schema
{
    ...
    protected static function table($name)
    {
        if (Config::get('database.prefixing')) {
            $name = Config::get('database.prefixe').$name;
        }
        //
        return $name;
    }
    ...
    public static function create($name, $script)
    {
        if (!self::existe($name)) {
            ...
            throw new SchemaTableExistsException($name);
        }
    }
    ...
    {
        if (!self::existe($from)) {
            throw new SchemaTableNotExistException($from);
        } elseif (self::existe($to)) {
            throw new SchemaTableExistsException($to);
        } else {
