...
class Storage
{
    ...
    protected function prependNonStatic($name, $content)
    {
        if ($this->exists($name)) {
            ...
            throw new \InvalidArgumentException("There is no file calls $name to prepend");
        }
    }
    ...
    protected function filesNonStatic($name = '')
    {
        if ($this->isDir($name)) {
            ...
            foreach ($r as $key => $value) {
                if (is_file($this->storagePath.'/'.$value)) {
                    $files[] = $value;
                }
            }
    ...
    protected static function filesStatic($name = '')
    {
        ...
        if ($self->isDir($name)) {
            ...
            foreach ($r as $key => $value) {
                if (is_file($self->storagePath.'/'.$value)) {
                    $files[] = $value;
                }
            }
    ...
    protected function directorysNonStatic($name = '')
    {
        if ($this->isDir($name)) {
            ...
            $r = scandir($this->path($name));
            foreach ($r as $key => $value) {
                if (is_dir($this->storagePath.'/'.$value)) {
                    $files[] = $value;
                }
            }
    ...
    {
        switch ($name) {
            case 'put': return call_user_func_array([$this, 'putNonStatic'], $args); break;
            case 'exists': return call_user_func_array([$this, 'existsNonStatic'], $args); break;
            case 'get': return call_user_func_array([$this, 'getNonStatic'], $args); break;
            case 'prepend': return call_user_func_array([$this, 'prependNonStatic'], $args); break;
            case 'append': return call_user_func_array([$this, 'appendNonStatic'], $args); break;
            case 'size': return call_user_func_array([$this, 'sizeNonStatic'], $args); break;
            case 'delete': return call_user_func_array([$this, 'deleteNonStatic'], $args); break;
            case 'copy': return call_user_func_array([$this, 'copyNonStatic'], $args); break;
            case 'move': return call_user_func_array([$this, 'moveNonStatic'], $args); break;
            case 'lastModified': return call_user_func_array([$this, 'lasteditNonStatic'], $args); break;
            case 'files': return call_user_func_array([$this, 'filesNonStatic'], $args); break;
            case 'directories': return call_user_func_array([$this, 'directorysNonStatic'], $args); break;
            case 'makeDirectory': return call_user_func_array([$this, 'makeDirNonStatic'], $args); break;
            case 'deleteDirectory': return call_user_func_array([$this, 'deleteDirNonStatic'], $args); break;
    ...
    {
        switch ($name) {
            case 'put': return call_user_func_array(['Storage', 'putStatic'], $args); break;
            case 'exists': return call_user_func_array(['Storage', 'existsStatic'], $args); break;
            case 'get': return call_user_func_array(['Storage', 'getStatic'], $args); break;
            case 'prepend': return call_user_func_array(['Storage', 'prependStatic'], $args); break;
            case 'append': return call_user_func_array(['Storage', 'appendStatic'], $args); break;
            case 'size': return call_user_func_array(['Storage', 'sizeStatic'], $args); break;
            case 'delete': return call_user_func_array(['Storage', 'deleteStatic'], $args); break;
            case 'copy': return call_user_func_array(['Storage', 'copyStatic'], $args); break;
            case 'move': return call_user_func_array(['Storage', 'moveStatic'], $args); break;
            case 'lastModified': return call_user_func_array(['Storage', 'lasteditStatic'], $args); break;
            case 'files': return call_user_func_array(['Storage', 'filesStatic'], $args); break;
            case 'directories': return call_user_func_array(['Storage', 'directorysStatic'], $args); break;
            case 'makeDirectory': return call_user_func_array(['Storage', 'makeDirStatic'], $args); break;
            case 'deleteDirectory': return call_user_func_array(['Storage', 'deleteDirStatic'], $args); break;
