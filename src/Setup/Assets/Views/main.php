...
<html>
	...
	<?php 
		...
		//
		// Libs::css(Application::$root."vendor/vinala/kernel/src/Setup/Assets/bootstrap-3.3.1.min.css",false);
		// Libs::css(Application::$root."vendor/vinala/kernel/src/Setup/Assets/bootstrap-theme-3.3.1.min.css",false);
		// Libs::js(Application::$root."vendor/vinala/kernel/src/Setup/Assets/jquery-1.11.3.min.js",false);
		//
		Html::charset("utf-8"); 
		Html::title();
