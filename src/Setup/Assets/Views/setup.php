...
<!-- <div class="bg" id="bg"></div> -->
	...
	<div id="fst_db_conf_step" style="display:none">
		...
		<form class="vnl-config-form vnl-config-db-form" id="vnl-config-db-form">
			<div class="control_c_row">
				...
				<div class="vnl-config-input-desc db-input-input-desc">The name of server where you host your database</div>
			</div>
			...
			<div class="control_c_row">
				...
				<div class="vnl-config-input-desc db-input-input-desc">The name of the database that you want to use Vinala.</div>
			</div>
			...
			<div class="control_c_row">
				...
				<div class="vnl-config-input-desc db-input-input-desc">The database user identifier to login to database.</div>
			</div>
			...
			<div class="control_c_row">
				...
				<div class="vnl-config-input-desc db-input-input-desc">The password of database user to login to database.</div>
			</div>
			...
			<div class="control_c_row">
				...
				<div class="vnl-config-input-desc db-input-input-desc">To secure your database and mark all tables of that project .</div>
			</div>

			<div class="control_c_row">
				<div class="vnl-config-error" id="fst_db_config_error">
					<div class="vnl-config-error-title">Error connecting to the database</div>
	...
	<div id="fst_pass_msg_step" style="display:none">
		...
		<div class="vnl-lonly-left-buttun-cont">
	...
	<div id="fst_glob_conf_step" style="display:none">
		...
		<form class="vnl-config-form vnl-config-db-form" id="vnl-glob-db-form">
	...
	<div id="fst_sec_conf_step" style="display:none">
		...
		<div class="vnl-config-cont">
			<form class="vnl-config-form vnl-config-db-form" id="vnl-sec-db-form">
				<div class="control_c_row">
					...
					<div class="vnl-config-input-desc db-input-input-desc">The first token</div>
				</div>
				...
				<div class="control_c_row">
					...
					<div class="vnl-config-input-desc db-input-input-desc">The second token</div>
				</div>
	...
	<div id="fst_pnl_conf_step" style="display:none">
		...
		<div class="vnl-config-cont">
			<form class="vnl-config-form vnl-config-db-form" id="vnl-pnl-db-form">
				...
				<div class="control_c_row">
					...
					<div class="vnl-config-input-desc db-input-input-desc">Do you want activate panel ?</div>
				</div>
				...
				<div class="control_c_row">
					...
					<div class="vnl-config-input-desc db-input-input-desc">what's HTTP access for panel ?</div>
				</div>
				...
				<div class="control_c_row">
					...
					<div class="vnl-config-input-desc db-input-input-desc">the first password to access to panel</div>
				</div>
				...
				<div class="control_c_row">
					...
					<div class="vnl-config-input-desc db-input-input-desc">the second password to access to panel</div>
				</div>
