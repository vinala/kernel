<!DOCTYPE html>
<?php 
 $dashboardRoot = "../vendor/lighty/kernel/src/Dashboard/";
?>
...
<meta http-equiv="content-type" content="text/html;charset=UTF-8" />
    ...
    <!-- HTML HEAD -->
    <?php include_once $dashboardRoot.'views/parts/head.php';  ?>    

    

    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-md">
        <!-- BEGIN HEADER -->
        <?php include_once $dashboardRoot.'views/parts/header.php'; ?>
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="sidebar-search-wrapper">
                            ...
                            <form class="sidebar-search  " action="http://keenthemes.com/preview/metronic/theme/admin_1_material_design/page_general_search_3.html" method="POST">
...
<!-- Mirrored from keenthemes.com/preview/metronic/theme/admin_1_material_design/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Jun 2016 21:13:49 GMT -->
</html>