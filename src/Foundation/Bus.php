...
class Bus
{
    ...
    private static function router()
    {
        ...
        $files = ['RouteDuplicatedException', 'RouteMiddlewareNotFoundException', 'RouteNotFoundInRoutesRegisterException', 'NotFoundHttpException'];
    ...
    {
        $files = ['Process', 'Command', 'Translator', 'Schema', 'Links', 'Tag', 'Model', 'View', 'Controller', 'Seeds', 'Router', 'Exception', 'Events', 'Alias', 'Middleware', 'Helper', 'Tests'];
