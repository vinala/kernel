...
class Router extends Process
{
    ...
    protected static function funcGet($route)
    {
        ...
        //
        if (count($params) > 0) {
            return 'get(\''.$route.'\',function('.self::formatParams($params).')';
        } else {
            return 'get(\''.$route.'\',function()';
        }
    }
    ...
    protected static function funcPost($route)
    {
        ...
        //
        if (count($params) > 0) {
            return 'post(\''.$route.'\',function('.self::formatParams($params).')';
        } else {
            return 'post(\''.$route.'\',function()';
        }
    }
